...
export declare type ActorUpdateOptions = Pick<Actor, 'name' | 'description' | 'isPublic' | 'seoTitle' | 'seoDescription' | 'issuesEnabled' | 'title' | 'restartOnError' | 'versions' | 'categories' | 'defaultRunOptions'>;
